...
import 'package:ecommerce_mobile/preference/icon-group1_icons.dart';
      ...
      body: ListView(
        ...
        children: [
          Row(
            ...
            children: [
              Icon(Icon_group1.group4, size: 24, color: Color(0xfffFA451)),
              Column(
                children: [
                  Icon(Icon_group1.vector, size: 24, color: Color(0xfffFA451)),
                  SizedBox(width: 8),
                  Text(
                    'My Basket',
          ...
          Row(
            children: [
              ...
              SizedBox(width: 8),
              Icon(Icon_group1.filter, size: 24, color: Color(0xfffFA451)),
            ],
          ),
